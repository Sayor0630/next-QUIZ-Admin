...
const Admin = () => {
  ...
  // Function to determine the content to be displayed in the right answer menu
  const getRightAnswerContent = (option, questionIndex, optionIndex) => {
    if (option.croppedImage) {
      // If there is a cropped image, display it
      return (
        <div className="mt-2">
          <img
      ...
      // If no image is uploaded, display rich text or math text based on the input type
      return (
        <>
  ...
  return (
    ...
    <div className='flex flex-col'>
      ...
      <select
        value={questions[questionIndex].correctOptionIndex}
        onChange={(e) => {
          const updatedQuestions = [...questions];
  ...
  {/* Display content based on the selected correct option */}
